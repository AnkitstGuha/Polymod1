...
const ABI = require("../artifacts/contracts/KingAnkit.sol/KingAnkit.json");
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("KingAnkit");
  const ethNFTAddress = await NFT.attach("0xb8d3BfA8fFB796DABe1E887D63860a07eBe1b198"); // ye change hoga as per contract address
